...
fn base_fs_fields<'a>(name: &'a str, fs_path: &'a str) -> Vec<(&'static str, &'a str)> {
    vec![
        ...
        ("syncer[vdir_pw][mode]", "SECRETSERVICE"),
        ("syncer[vdir_pw][attr_key]", ""),
        ("syncer[vdir_pw][attr_value]", ""),
        ("syncer[vdir_pw][cmd]", ""),
        ("syncer[vdir_time_span]", "infinite"),
        ("syncer[vdir_time_span_years]", "5"),
        ("syncer[o365_name]", ""),
        ("syncer[o365_email]", ""),
        ("syncer[o365_pw][mode]", "SECRETSERVICE"),
        ("syncer[o365_pw][attr_key]", ""),
        ("syncer[o365_pw][attr_value]", ""),
        ("syncer[o365_pw][cmd]", ""),
...
fn base_vdir_fields(name: &str) -> Vec<(&'static str, &str)> {
    vec![
        ...
        ("syncer[vdir_username]", ""),
        ("syncer[vdir_pw][mode]", "SECRETSERVICE"),
        ("syncer[vdir_pw][attr_key]", "vdirsyncer"),
        ("syncer[vdir_pw][attr_value]", "alice"),
        ("syncer[vdir_pw][cmd]", ""),
        ("syncer[vdir_time_span]", "infinite"),
        ("syncer[vdir_time_span_years]", "5"),
        ("syncer[fs_path]", ""),
...
fn base_o365_fields(name: &str) -> Vec<(&'static str, &str)> {
    vec![
        ...
        ("syncer[o365_pw][mode]", "COMMAND"),
        ("syncer[o365_pw][attr_key]", ""),
        ("syncer[o365_pw][attr_value]", ""),
        ("syncer[o365_pw][cmd]", "pass show myaccount"),
        ("syncer[o365_time_span]", "infinite"),
        ("syncer[o365_time_span_years]", "5"),
        ("syncer[fs_path]", ""),
        ("syncer[vdir_name]", ""),
